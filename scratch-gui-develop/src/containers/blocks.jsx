...
class Blocks extends React.Component {
    ...
    componentDidMount () {
        ...
        // blocks 初始化
        console.log('blocks 初始化!');
        this.workspace = this.ScratchBlocks.inject(this.blocks, workspaceConfig);

        // Register buttons under new callback keys for creating variables,
        // lists, and procedures from extensions.
        
        console.log('获取 flyout 就是展示积木块的地方 和 workspace ');
    ...
    updateToolbox () {
        console.log('blcoks 实例中的 updateToolbox！触发');
        // 所以最终是在这里更新了 toolbox
    ...
    onWorkspaceUpdate (data) {
        ...
        if (toolboxXML) {
            console.log('this.props.updateToolboxState(toolboxXML);');
