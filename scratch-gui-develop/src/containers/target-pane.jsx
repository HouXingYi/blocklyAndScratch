...
class TargetPane extends React.Component {
    ...
    componentDidMount () {
        ...
        console.log('target-pane 组件，就是角色控制面板，实际上是在调用 vm 中的 api，调用 vm 中的api 直接就可以影响到 stage 的图像');
